...
class GptprotoTextToSpeechModel(TTSModel):
    """
    Model class for GPTProto text to speech model.
    """

    api_base: str = "https://gptproto.com"
    ...
    def _tts_invoke(
        ...
        url = base_url + "/gptproto/audio/speech"
        headers = {
