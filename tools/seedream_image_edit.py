...
class SeedreamImageEditTool(Tool):
    """
    Tool for editing images using text prompts and reference images via ByteDance Seedream 4.0 model.
    """

    def _invoke(self, tool_parameters: dict[str, Any]) -> Generator[ToolInvokeMessage]:
        """
        Invoke the Seedream image edit tool.
        """
    ...
    def _submit_task(
        ...
        """
        url = f"{API_BASE}/bytedance/seedream-4-0-250828/image-edit"
        headers = {
