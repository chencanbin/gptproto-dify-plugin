...
class Hailuo23StandardImageToVideoTool(Tool):
    """
    Tool for generating videos from images using MiniMax Hailuo 2.3 Standard model via GPTProto API.
    """

    def _invoke(self, tool_parameters: dict[str, Any]) -> Generator[ToolInvokeMessage]:
        """
        Invoke the Hailuo 2.3 Standard image-to-video tool.
        """
    ...
    def _submit_task(
        ...
        """
        url = f"{API_BASE}/minimax/hailuo-2.3-standard/image-to-video"
        headers = {
