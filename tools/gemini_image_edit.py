...
class GeminiImageEditTool(Tool):
    """
    Tool for editing images using text prompts and reference images via Google Gemini model.
    """

    def _invoke(self, tool_parameters: dict[str, Any]) -> Generator[ToolInvokeMessage]:
        """
        Invoke the Gemini image edit tool.
        """
    ...
    def _submit_task(
        ...
        """
        url = f"{API_BASE}/google/gemini-3-pro-image-preview/image-edit"
        headers = {
