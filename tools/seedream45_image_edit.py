...
class Seedream45ImageEditTool(Tool):
    """
    Tool for editing images using text prompts and reference images via ByteDance Seedream 4.5 model.
    """

    def _invoke(self, tool_parameters: dict[str, Any]) -> Generator[ToolInvokeMessage]:
        """
        Invoke the Seedream 4.5 image edit tool.
        """
        ...
        size = tool_parameters.get("size", "1024*1024")
    ...
    def _submit_task(
        ...
        """
        url = f"{API_BASE}/bytedance/seedream-4-5-251128/image-edit"
        headers = {
